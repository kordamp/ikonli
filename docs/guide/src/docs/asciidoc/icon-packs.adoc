...
.gradle
----
compile '{project-group}:ikonli-bpmn-pack:{project-version}'
----
...
.gradle
----
compile '{project-group}:ikonli-simplelineicons-pack:{project-version}'
----
...
.gradle
----
compile '{project-group}:ikonli-whhg-pack:{project-version}'
----
