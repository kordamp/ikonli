...
public enum FontAwesomeBrands implements Ikon {
    ...
    FIGMA("fab-figma", '\uf799'),
    FIREFOX("fab-firefox", '\uf269'),
    FIREFOX_BROWSER("fab-firefox-browser", '\uf907'),
    ...
    INSTAGRAM_SQUARE("fab-instagram-square", '\uf955'),
    ...
    PIED_PIPER_SQUARE("fab-pied-piper-square", '\uf91e'),
