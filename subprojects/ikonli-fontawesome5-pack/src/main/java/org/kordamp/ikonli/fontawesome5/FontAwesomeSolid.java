...
public enum FontAwesomeSolid implements Ikon {
    ...
    HANDSHAKE_ALT_SLASH("fas-handshake-alt-slash", '\uf95f'),
    HANDSHAKE_SLASH("fas-handshake-slash", '\uf960'),
    HANDS_HELPING("fas-hands-helping", '\uf4c4'),
    HANDS_WASH("fas-hands-wash", '\uf95e'),
    HAND_HOLDING("fas-hand-holding", '\uf4bd'),
    HAND_HOLDING_HEART("fas-hand-holding-heart", '\uf4be'),
    HAND_HOLDING_MEDICAL("fas-hand-holding-medical", '\uf95c'),
    ...
    HAND_SPARKLES("fas-hand-sparkles", '\uf95d'),
    ...
    HEADSET("fas-headset", '\uf590'),
    HEAD_SIDE_COUGH("fas-head-side-cough", '\uf961'),
    HEAD_SIDE_COUGH_SLASH("fas-head-side-cough-slash", '\uf962'),
    HEAD_SIDE_MASK("fas-head-side-mask", '\uf963'),
    HEAD_SIDE_VIRUS("fas-head-side-virus", '\uf964'),
    HEART("fas-heart", '\uf004'),
    ...
    LAPTOP_HOUSE("fas-laptop-house", '\uf966'),
    ...
    PEOPLE_ARROWS("fas-people-arrows", '\uf968'),
    ...
    PUMP_MEDICAL("fas-pump-medical", '\uf96a'),
    ...
    SHIELD_VIRUS("fas-shield-virus", '\uf96c'),
    SHIP("fas-ship", '\uf21a'),
    ...
    STOPWATCH_20("fas-stopwatch-20", '\uf96f'),
    STOP_CIRCLE("fas-stop-circle", '\uf28d'),
    STORE("fas-store", '\uf54e'),
    STORE_ALT("fas-store-alt", '\uf54f'),
    STORE_ALT_SLASH("fas-store-alt-slash", '\uf970'),
    STORE_SLASH("fas-store-slash", '\uf971'),
    STREAM("fas-stream", '\uf550'),
    ...
    TOILET_PAPER_SLASH("fas-toilet-paper-slash", '\uf972'),
    TOOLBOX("fas-toolbox", '\uf552'),
    TOOLS("fas-tools", '\uf7d9'),
    TOOTH("fas-tooth", '\uf5c9'),
    TORAH("fas-torah", '\uf6a0'),
    ...
    VIHARA("fas-vihara", '\uf6a7'),
    VIRUS("fas-virus", '\uf974'),
    VIRUSES("fas-viruses", '\uf976'),
    VIRUS_SLASH("fas-virus-slash", '\uf975'),
