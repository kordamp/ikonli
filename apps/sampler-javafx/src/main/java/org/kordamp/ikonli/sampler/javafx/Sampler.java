...
import org.kordamp.ikonli.fluentui.FluentUiFilled;
import org.kordamp.ikonli.fluentui.FluentUiRegular;
...
public class Sampler extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        tabPane.getTabs().add(new DemoTab(FluentUiFilled.class, allOf(FluentUiFilled.class)));
        tabPane.getTabs().add(new DemoTab(FluentUiRegular.class, allOf(FluentUiRegular.class)));
